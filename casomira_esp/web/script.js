...
function addProudari(pohlavi, pravyProud, levyProud, datum)
{
	var found = false;
	proudari[pohlavi].pProud[proudari[pohlavi].pProud.length]=pravyProud;
	proudari[pohlavi].lProud[proudari[pohlavi].lProud.length]=levyProud;
